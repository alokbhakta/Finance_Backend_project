...
import { createRecordValidator, updateRecordValidator, deleteRecordValidator, getRecordsValidator } from '../validators/record.validator.js';
import validate from '../middleware/validate.middleware.js';

const router= express.Router();

router.post('/',auth,role('admin','analyst'), createRecordValidator, validate, createRecord);
router.get('/',auth, getRecordsValidator, validate, getRecords);
